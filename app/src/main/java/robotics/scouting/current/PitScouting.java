...
public class PitScouting extends AppCompatActivity implements View.OnClickListener, NavigationView.OnNavigationItemSelectedListener {
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        switch (id){
            ...
            case R.id.newAlliance:
                Intent intent4 = new Intent(PitScouting.this,AllianceActivity.class);
                startActivity(intent4);
                clearData();
                break;
            case R.id.mainMenu:
                Intent intent3 = new Intent(PitScouting.this,SplashActivity.class);
                startActivity(intent3);
                break;
            case R.id.FileViewer:
                Intent intent1 = new Intent(PitScouting.this,FileListActivity.class);
            ...
            case R.id.share:
                ...
                break;
            case R.id.faq:
                Intent intent2 = new Intent(PitScouting.this,faqActivityMain.class);
        ...
        switch (view.getId()) {
            case R.id.fab:
                ...
                if (beforeFrag != null && beforeFrag.isVisible()) {
                    Intent intent = new Intent(PitScouting.this,SplashActivity.class);
                    startActivity(intent);
    ...
    public boolean checkPermission(){
        int result = ContextCompat.checkSelfPermission(PitScouting.this, Manifest.permission.WRITE_EXTERNAL_STORAGE);
    ...
    private void requestPermission(){
        if (ActivityCompat.shouldShowRequestPermissionRationale(PitScouting.this, Manifest.permission.WRITE_EXTERNAL_STORAGE)) {
            Toast.makeText(PitScouting.this,"Storage permission is required, please allow it from settings.",Toast.LENGTH_SHORT).show();
        }else{
            ActivityCompat.requestPermissions(PitScouting.this,new String[] {Manifest.permission.WRITE_EXTERNAL_STORAGE},111);
        }
    }
    ...
    public static void setBalance(String balance) {
        PitScouting.balance = balance;
    }
    public static void setMatch(int match) {
        PitScouting.match = match;
    }
    public static void setTeam(int team) {
        PitScouting.team = team;
    }
    public static void setAutoC(String autoC) {
        PitScouting.autoC = autoC;
    }
    public static void setTeleC(String teleC) {
        PitScouting.teleC = teleC;
    }
    public static void setGrid( ArrayList<Integer> grid) {
        PitScouting.grid = grid;
    }
    public static void setTeleGrid( ArrayList<Integer> teleGrid) {
        PitScouting.teleGrid = teleGrid;
    }
    public static void setTime(int mins,int secs,int millis) {
        PitScouting.mins = mins;
        PitScouting.secs = secs;
        PitScouting.millis = millis;
        PitScouting.time = String.valueOf(secs) + "." + String.valueOf(millis);
    }
